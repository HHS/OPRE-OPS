...
- a.i.4 | see a.i.1.
- a.i.5 | see a.i.1.
- a.i.6 | Administrative and security functions executed within the OPS app itself are logged and recorded. Activities occurring at the infrastructure/Azure level are also logged via Azure Monitor and other tooling within Azure.
- a.i.7 | User audit logging is possible at the infrastructure/Azure level.  TODO: define what sensitive data is ?
- a.i.8 | see a.i.1.
- a.i.9 | see a.i.1.
- a.i.10 | TODO: ??
