...
f. An OPS account manager has the ability to approve new users, alter assigned permissions/roles, inactivate users, and reactivate users and can do so once favorable adjudication has been received for new users and authorized requests for removal, creation, and modification.
