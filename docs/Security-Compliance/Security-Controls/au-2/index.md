...
The OPRE system inherits audit tools and capabilities from Cloud.gov and login.gov to audit the logs of Developer and OPS user account actions, respectively. 
...
- a.i.8 | Account creation through Login.gov, modification and deletion logged in OPRE
- a.i.9 | Logged in OPRE
...
- System Administration activities are logged in OPRE
- Modifications of privileges and access are logged in OPRE
- Account creation is inherited from Login.gov
- Account modification and deletion is logged in OPRE
