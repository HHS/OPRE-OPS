Feature: Load new Research Projects and Agreements from Sheila's Excel file: REDACTED-FY22_Budget_Summary-10-12-22.xlsm
  ...
  Scenario Outline: Create a new CAN
    ...
    Then a CAN should be created with CAN.number = <number>
    And the CAN should have CAN.description = <description>
    Examples:
      | string                   | number  | description    |
      | GXXXXXX                  | GXXXXXX | null           |
      | GXXXXXX (CC - SB - 5 YR) | GXXXXXX | CC - SB - 5 YR |
      | GXXXXXX (WR)             | GXXXXXX | WR             |
