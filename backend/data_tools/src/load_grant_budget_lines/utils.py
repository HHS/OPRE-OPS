...
class GrantBudgetLineItemData:
    ...
    YEAR: Optional[int] = field(load_default=None, dump_default=None)
    BNS_NBR: Optional[str] = field(load_default=None, dump_default=None)
    COMMITTED_DATE: Optional[date] = field(load_default=None, dump_default=None)
    FA_SIGNED_DATE: Optional[date] = field(load_default=None, dump_default=None)
    OBLIGATED_DATE: Optional[date] = field(load_default=None, dump_default=None)
    BUDGET_START_DATE: Optional[date] = field(load_default=None, dump_default=None)
    BUDGET_END_DATE: Optional[date] = field(load_default=None, dump_default=None)
    OBJECT_CLASS_CODE: Optional[int] = field(load_default=None, dump_default=None)
    ENABLE: Optional[bool] = field(load_default=None, dump_default=None)
    GRANTS_NBR: Optional[str] = field(load_default=None, dump_default=None)
    GRANTEE: Optional[str] = field(load_default=None, dump_default=None)
    EDUCATIONAL_INSTITUTE: Optional[bool] = field(load_default=None, dump_default=None)
    STATE_CODE: Optional[StateCode] = field(load_default=None, dump_default=None)
