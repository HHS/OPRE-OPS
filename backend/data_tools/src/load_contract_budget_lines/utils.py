...
class BudgetLineItemData:
    ...
    INVOICE_LINE_NBR: Optional[int] = field(load_default=None, dump_default=None)
    SYS_TYPE_OF_MODE_ID: Optional[ModType] = field(load_default=None, dump_default=None)
    EXTEND_POP_TO: Optional[date] = field(load_default=None, dump_default=None)
    ZERO_REQUISITION_NBR: Optional[str] = field(load_default=None, dump_default=None)
    ZERO_REQUISITION_DATE: Optional[date] = field(load_default=None, dump_default=None)
    REQUISITION_NBR: Optional[str] = field(load_default=None, dump_default=None)
    REQUISITION_DATE: Optional[date] = field(load_default=None, dump_default=None)
    OBJECT_CLASS_CODE: Optional[int] = field(load_default=None, dump_default=None)
    MOD_NBR: Optional[str] = field(load_default=None, dump_default=None)
    DOC_RECEIVED: Optional[bool] = field(load_default=None, dump_default=None)
    PSC_FEE_DOC_NBR: Optional[str] = field(load_default=None, dump_default=None)
    PSC_FEE_PYMT_REF_NBR: Optional[str] = field(load_default=None, dump_default=None)
    OBLIGATION_DATE: Optional[date] = field(load_default=None, dump_default=None)
    CERTIFIED: Optional[bool] = field(load_default=None, dump_default=None)
    PERF_START_DATE: Optional[date] = field(load_default=None, dump_default=None)
    PERF_END_DATE: Optional[date] = field(load_default=None, dump_default=None)
    CLOSED: Optional[bool] = field(load_default=None, dump_default=None)
    CLOSED_BY: Optional[int] = field(load_default=None, dump_default=None)
    CLOSE_DATE: Optional[date] = field(load_default=None, dump_default=None)
    REQUISITION_GROUP: Optional[int] = field(load_default=None, dump_default=None)
    REQUISITION_CHECK: Optional[str] = field(load_default=None, dump_default=None)
    SYS_AAP_ID: Optional[int] = field(load_default=None, dump_default=None)
    SYS_CLIN_ID: Optional[int] = field(load_default=None, dump_default=None)
    ON_HOLD: Optional[bool] = field(load_default=None, dump_default=None)
    ...
    CLIN_NAME: Optional[str] = field(load_default=None, dump_default=None)
    CLIN: Optional[int] = field(load_default=None, dump_default=None)
    POP_START_DATE: Optional[date] = field(load_default=None, dump_default=None)
    POP_END_DATE: Optional[date] = field(load_default=None, dump_default=None)
