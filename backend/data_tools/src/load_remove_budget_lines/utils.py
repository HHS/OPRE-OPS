...
class BudgetLineItemData:
    ...
    SYS_BUDGET_ID: int
    EFFECTIVE_DATE: Optional[str] = field(load_default=None, dump_default=None)
    REQUESTED_BY: Optional[str] = field(load_default=None, dump_default=None)
    HOW_REQUESTED: Optional[str] = field(load_default=None, dump_default=None)
    CHANGE_REASONS: Optional[str] = field(load_default=None, dump_default=None)
    WHO_UPDATED: Optional[str] = field(load_default=None, dump_default=None)
    FISCAL_YEAR: Optional[str] = field(load_default=None, dump_default=None)
    CAN: Optional[str] = field(load_default=None, dump_default=None)
    PROJECT_TITLE: Optional[str] = field(load_default=None, dump_default=None)
    CIG_NAME: Optional[str] = field(load_default=None, dump_default=None)
    CIG_TYPE: Optional[str] = field(load_default=None, dump_default=None)
    LINE_DESC: Optional[str] = field(load_default=None, dump_default=None)
    DATE_NEEDED: Optional[str] = field(load_default=None, dump_default=None)
    AMOUNT: Optional[str] = field(load_default=None, dump_default=None)
    PROC_FEE_AMOUNT: Optional[str] = field(load_default=None, dump_default=None)
    STATUS: Optional[str] = field(load_default=None, dump_default=None)
    COMMENTS: Optional[str] = field(load_default=None, dump_default=None)
    NEW_VS_CONTINUING: Optional[str] = field(load_default=None, dump_default=None)
    APPLIED_RESEARCH_VS_EVALUATIVE: Optional[str] = field(load_default=None, dump_default=None)
