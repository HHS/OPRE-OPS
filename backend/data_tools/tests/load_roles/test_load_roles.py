...
def test_create_role_data():
    ...
    assert create_role_data(test_data[0]).PERMISSIONS == {"GET_AGREEMENT","PUT_AGREEMENT","PATCH_AGREEMENT","POST_AGREEMENT","GET_BUDGET_LINE_ITEM","PUT_BUDGET_LINE_ITEM","PATCH_BUDGET_LINE_ITEM","POST_BUDGET_LINE_ITEM","GET_SERVICES_COMPONENT","PUT_SERVICES_COMPONENT","PATCH_SERVICES_COMPONENT","POST_SERVICES_COMPONENT","DELETE_SERVICES_COMPONENT","GET_BLI_PACKAGE","PUT_BLI_PACKAGE","PATCH_BLI_PACKAGE","POST_BLI_PACKAGE","GET_CAN","PUT_CAN","PATCH_CAN","POST_CAN","DELETE_CAN","GET_DIVISION","GET_NOTIFICATION","PUT_NOTIFICATION","PATCH_NOTIFICATION","GET_PORTFOLIO","PUT_PORTFOLIO","PATCH_PORTFOLIO","POST_PORTFOLIO","GET_RESEARCH_PROJECT","POST_RESEARCH_PROJECT","PUT_RESEARCH_PROJECT","POST_RESEARCH_PROJECT","GET_USER","PUT_USER","PATCH_USER","GET_HISTORY","GET_CHANGE_REQUEST","PUT_CHANGE_REQUEST","PATCH_CHANGE_REQUEST","POST_CHANGE_REQUEST","GET_CHANGE_REQUEST_REVIEW","PUT_CHANGE_REQUEST_REVIEW","PATCH_CHANGE_REQUEST_REVIEW","POST_CHANGE_REQUEST_REVIEW","GET_UPLOAD_DOCUMENT","POST_UPLOAD_DOCUMENT"}
