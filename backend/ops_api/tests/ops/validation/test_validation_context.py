...
class TestValidationContext:
    ...
    def test_validation_context_creation(self, test_user, loaded_db):
    ...
    def test_validation_context_with_metadata(self, test_user, loaded_db):
    ...
    def test_get_metadata_returns_value(self, test_user, loaded_db):
    ...
    def test_get_metadata_returns_default_when_key_not_found(self, test_user, loaded_db):
    ...
    def test_set_metadata_adds_new_key(self, test_user, loaded_db):
    ...
    def test_set_metadata_updates_existing_key(self, test_user, loaded_db):
    ...
    def test_metadata_is_independent_instance(self, test_user, loaded_db):
