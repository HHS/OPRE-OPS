...
def test_administrative_and_support_projects_get_by_id(auth_client, loaded_db):
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-item", id="1013")
    )
    assert response.status_code == 200
...
def test_administrative_and_support_projects_get_by_id_404(auth_client, loaded_db):
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-item", id="1000")
    )
    assert response.status_code == 404


def test_administrative_and_support_projects_serialization(
...
def test_administrative_and_support_projects_with_fiscal_year_found(
    auth_client, loaded_db
):
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-group", fiscal_year=2023)
    )
    assert response.status_code == 200
...
def test_administrative_and_support_projects_with_fiscal_year_not_found(
    auth_client, loaded_db
):
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-group", fiscal_year=2000)
    )
    assert response.status_code == 200
...
def test_administrative_and_support_projects_search(auth_client, loaded_db):
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-group", search="")
    )
    ...
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-group", search="su")
    )
    ...
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-group", search="#2")
    )
    ...
    response = auth_client.get(
        url_for("api.administrative-and-support-projects-group", search="blah")
    )
...
def test_administrative_and_support_projects_get_by_id_auth(client, loaded_db):
    response = client.get(
        url_for("api.administrative-and-support-projects-item", id=14)
    )
...
def test_post_administrative_and_support_projects(auth_client):
    ...
    response = auth_client.post(
        url_for("api.administrative-and-support-projects-group"), json=data
    )
...
def test_post_administrative_and_support_projects_empty_post(auth_client):
    response = auth_client.post(
        url_for("api.administrative-and-support-projects-group"), json={}
    )
