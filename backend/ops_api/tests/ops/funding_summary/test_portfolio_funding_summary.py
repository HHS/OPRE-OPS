...
def test_get_budget_line_item_total_by_status(loaded_db):
    assert _get_budget_line_item_total_by_status(2, 2043, BudgetLineItemStatus.PLANNED) == Decimal("74350979.00")
    assert _get_budget_line_item_total_by_status(2, 2043, BudgetLineItemStatus.DRAFT) == Decimal("76762974.00")
