...
def test_get_budget_line_item_total_by_status(loaded_db):
    ...
    assert _get_budget_line_item_total_by_status(2, 2043, BudgetLineItemStatus.DRAFT) == Decimal("75425974.00000")
    assert _get_budget_line_item_total_by_status(2, 2043, BudgetLineItemStatus.IN_EXECUTION) == Decimal("29373692.00000")
