...
def test_get_budget_line_item_total_planned():
    result = _get_budget_line_item_total_by_status(100, 2023, "Planned")
    assert result == Decimal(1), "$1 BLI for FY 2023"

    result = _get_budget_line_item_total_by_status(100, 1900, "Planned")
    assert result == Decimal(0), "No CFY"

    result = _get_budget_line_item_total_by_status(1000, 2023, "Planned")
    assert result == Decimal(0), "No Portfolio"
...
def test_get_budget_line_item_total_in_execution():
    result = _get_budget_line_item_total_by_status(100, 2023, "In Execution")
    assert result == Decimal(2), "$2 BLI for FY 2023"

    result = _get_budget_line_item_total_by_status(100, 1900, "In Execution")
    assert result == Decimal(0), "No CFY"

    result = _get_budget_line_item_total_by_status(1000, 2023, "In Execution")
    assert result == Decimal(0), "No Portfolio"
...
def test_get_budget_line_item_total_obligated():
    result = _get_budget_line_item_total_by_status(100, 2023, "Obligated")
    assert result == Decimal(3), "$3 BLI for FY 2023"

    result = _get_budget_line_item_total_by_status(100, 1900, "Obligated")
    assert result == Decimal(0), "No CFY"

    result = _get_budget_line_item_total_by_status(1000, 2023, "Obligated")
    assert result == Decimal(0), "No Portfolio"
