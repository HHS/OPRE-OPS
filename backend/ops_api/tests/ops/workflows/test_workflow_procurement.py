...
from models import BudgetLineItem, BudgetLineItemStatus, WorkflowAction, WorkflowStepInstance, WorkflowStepStatus, WorkflowInstance, Package, PackageSnapshot
...
def test_creating_procurement_tracker_workflow(loaded_db):
    ...
    package.workflow_id = workflow_step_instance.id
    package.notes = ""
