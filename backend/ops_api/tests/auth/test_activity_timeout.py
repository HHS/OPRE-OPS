...
from models import OpsDBHistory, OpsEvent, UserSession
from models.users import User


@pytest.fixture()
def loaded_db_no_session(app: Flask, app_ctx: None):
...
def test_endpoint_no_active_session(auth_client, loaded_db_no_session, mocker):
    # setup mocks
