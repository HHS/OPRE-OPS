...
AGREEMENT_LIST_FILTER_OPTION_API_VIEW_FUNC = AgreementListFilterOptionAPI.as_view(
    "agreements-filters", Agreement
)
...
CAN_LIST_FILTER_OPTION_API_VIEW_FUNC = CANListFilterOptionAPI.as_view(
    "cans-filters", CAN
)
...
CHANGE_REQUEST_ITEM_API_VIEW_FUNC = ChangeRequestItemAPI.as_view(
    "change-requests-item", ChangeRequest
)
