...
class OpsService(Protocol[T]):
    def create(self, create_request: dict[str, Any], **kwargs) -> T: ...

    def update(self, id: int, updated_fields: dict[str, Any], **kwargs) -> tuple[T, int]: ...

    def delete(self, id: int, **kwargs) -> None: ...

    def get(self, id: int, **kwargs) -> T: ...

    def get_list(self, data: dict | None, **kwargs) -> tuple[list[T], dict | None]: ...
