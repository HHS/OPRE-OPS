...
class CreateUpdateFundingDetailsSchema(Schema):
    ...
    funding_source = fields.Enum(CANFundingSource, allow_none=True, load_default=None, by_value=True)
    method_of_transfer = fields.Enum(CANMethodOfTransfer, allow_none=True, load_default=None, by_value=True)
...
class FundingDetailsListSchema(Schema):
    ...
    funding_source = fields.Enum(CANFundingSource, allow_none=True, by_value=True)
    method_of_transfer = fields.Enum(CANMethodOfTransfer, allow_none=True, by_value=True)
    obligate_by = fields.Integer(allow_none=True)
