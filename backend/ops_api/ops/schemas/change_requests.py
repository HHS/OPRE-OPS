...
class ChangeRequestResponseSchema(Schema):
    ...
    requestor_notes = fields.String(dump_default=None, allow_none=True)
    managing_division_id = fields.Int(required=True, dump_default=None, allow_none=True)
    created_by = fields.Int(required=True)
    created_by_user = fields.Nested(SafeUserSchema(), dump_default=None, allow_none=True)
    created_on = fields.DateTime(required=True)
    reviewed_by = fields.Integer(allow_none=True)
    reviewed_on = fields.DateTime(required=True)
    reviewer_notes = fields.String(dump_default=None, allow_none=True)
