...
class AgreementRequestSchema(PaginationListSchema):
    ...
    include_budget_lines = fields.List(fields.Boolean(), required=False, load_default=[True])
...
class AgreementResponse(FyObligatedMixin, AgreementData):
    ...
    award_type = fields.String(load_default=None, dump_default=None, required=False, allow_none=True)
