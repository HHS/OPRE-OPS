...
SQLALCHEMY_DATABASE_URI = f"""postgres+psycopg2://{database_creds['db_name']}:{database_creds['password']}@{database_creds['host']}:{database_creds['port']}/{database_creds['db_name']}"""  # noqa: B950
