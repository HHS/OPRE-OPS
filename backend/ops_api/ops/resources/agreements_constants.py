...
AGREEMENT_ITEM_TYPE_TO_RESPONSE_MAPPING = {
    ...
    AgreementType.AA: AaAgreementResponse,
}

AGREEMENTS_REQUEST_SCHEMAS = {
    AgreementType.CONTRACT: AGREEMENT_TYPE_TO_DATACLASS_MAPPING.get(
    ...
    AgreementType.DIRECT_OBLIGATION: AGREEMENT_TYPE_TO_DATACLASS_MAPPING.get(
...
AGREEMENT_LIST_RESPONSE_SCHEMAS = {
    AgreementType.CONTRACT: AGREEMENT_LIST_TYPE_TO_RESPONSE_MAPPING.get(
        AgreementType.CONTRACT
    )(),
    AgreementType.GRANT: AGREEMENT_LIST_TYPE_TO_RESPONSE_MAPPING.get(
        AgreementType.GRANT
    )(),
    AgreementType.IAA: AGREEMENT_LIST_TYPE_TO_RESPONSE_MAPPING.get(AgreementType.IAA)(),
    AgreementType.DIRECT_OBLIGATION: AGREEMENT_LIST_TYPE_TO_RESPONSE_MAPPING.get(
        AgreementType.DIRECT_OBLIGATION
    )(),
...
AGREEMENT_ITEM_RESPONSE_SCHEMAS = {
    AgreementType.CONTRACT: AGREEMENT_ITEM_TYPE_TO_RESPONSE_MAPPING.get(
        AgreementType.CONTRACT
    )(),
    AgreementType.GRANT: AGREEMENT_ITEM_TYPE_TO_RESPONSE_MAPPING.get(
        AgreementType.GRANT
    )(),
    AgreementType.IAA: AGREEMENT_ITEM_TYPE_TO_RESPONSE_MAPPING.get(AgreementType.IAA)(),
    AgreementType.DIRECT_OBLIGATION: AGREEMENT_ITEM_TYPE_TO_RESPONSE_MAPPING.get(
        AgreementType.DIRECT_OBLIGATION
    )(),
}
