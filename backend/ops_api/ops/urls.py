...
from ops_api.ops.views import (
    ...
    PROCUREMENT_PRE_AWARD_LIST_API_VIEW_FUNC,
...
def register_api(api_bp: Blueprint) -> None:
    ...
    api_bp.add_url_rule(
        ...
        view_func=PROCUREMENT_ACQUISITION_PLANNING_LIST_API_VIEW_FUNC,
    )
    api_bp.add_url_rule(
    ...
    api_bp.add_url_rule(
        "/procurement-pre-solicitations/",
        view_func=PROCUREMENT_PRE_SOLICITATION_LIST_API_VIEW_FUNC,
    )
    api_bp.add_url_rule(
    ...
    api_bp.add_url_rule(
        ...
        view_func=PROCUREMENT_EVALUATION_LIST_API_VIEW_FUNC,
    )
    api_bp.add_url_rule(
    ...
    api_bp.add_url_rule(
        "/procurement-pre-awards/",
        view_func=PROCUREMENT_PRE_AWARD_LIST_API_VIEW_FUNC,
    )
    api_bp.add_url_rule(
