...
class ResearchMethodology(BaseModel):
    """
    A Research Methodology (RM) outlines the "how" when referring to a Research Agreement.
    ...
    contract_agreement_id - The ID of the Contract Agreement the Research Methodology is associated with
