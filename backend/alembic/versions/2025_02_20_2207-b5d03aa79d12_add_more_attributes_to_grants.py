...
down_revision: Union[str, None] = "04e9785794ca"
...
def upgrade() -> None:
    ...
    op.add_column(
        "grant_agreement", sa.Column("number_of_years", sa.Integer(), nullable=True)
    )
    op.add_column(
        "grant_agreement", sa.Column("number_of_grants", sa.Integer(), nullable=True)
    )
    op.alter_column("grant_agreement", "foa", existing_type=sa.VARCHAR(), nullable=True)
    op.add_column(
    ...
    op.add_column(
        "grant_agreement_version",
        sa.Column("number_of_years", sa.Integer(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "grant_agreement_version",
        sa.Column("number_of_grants", sa.Integer(), autoincrement=False, nullable=True),
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "grant_agreement", "foa", existing_type=sa.VARCHAR(), nullable=False
    )
