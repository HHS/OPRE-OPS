...
def upgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "can_funding_budget", sa.Column("can_id", sa.Integer(), nullable=False)
    )
    ...
    op.add_column(
        "can_funding_received", sa.Column("can_id", sa.Integer(), nullable=False)
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "can_funding_received_version",
        sa.Column("fund_code", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.drop_column("can_funding_received_version", "can_id")
    op.add_column(
        "can_funding_received",
        sa.Column("fund_code", sa.VARCHAR(), autoincrement=False, nullable=False),
    )
