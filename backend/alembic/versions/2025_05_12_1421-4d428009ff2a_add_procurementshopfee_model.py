...
def upgrade() -> None:
    ...
    op.add_column(
        "budget_line_item",
        sa.Column("procurement_shop_fee_id", sa.Integer(), nullable=True),
    )
    ...
    op.add_column(
        ...
        sa.Column(
            "procurement_shop_fee_id", sa.Integer(), autoincrement=False, nullable=True
        ),
    )
    # ### end Alembic commands ###
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("budget_line_item_version", "procurement_shop_fee_id")
    op.drop_constraint(None, "budget_line_item", type_="foreignkey")
    op.drop_column("budget_line_item", "procurement_shop_fee_id")
    # ### end Alembic commands ###
