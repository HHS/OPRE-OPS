"""Collecting all db changes for agreement history pr

Revision ID: 5a07ade95730
Revises: 8768c59ac795
Create Date: 2025-09-18 15:06:18.262322+00:00
...
def upgrade() -> None:
    ...
    sa.Enum('AGREEMENT_CREATED', 'AGREEMENT_UPDATED', 'AGREEMENT_DELETED', 'BUDGET_LINE_ITEM_CREATED', 'BUDGET_LINE_ITEM_UPDATED', 'BUDGET_LINE_ITEM_DELETED', 'CHANGE_REQUEST_CREATED', 'CHANGE_REQUEST_UPDATED', 'CHANGE_REQUEST_DELETED', 'PROCUREMENT_SHOP_UPDATED', 'SERVICE_COMPONENT_CREATED', 'SERVICE_COMPONENT_UPDATED', 'SERVICE_COMPONENT_DELETED', name='agreementhistorytype').create(op.get_bind())
    op.create_table('agreement_history_version',
    sa.Column('id', sa.Integer(), autoincrement=False, nullable=False),
    sa.Column('agreement_id', sa.Integer(), autoincrement=False, nullable=True),
    sa.Column('agreement_id_record', sa.Integer(), autoincrement=False, nullable=True),
    sa.Column('budget_line_id', sa.Integer(), autoincrement=False, nullable=True),
    sa.Column('budget_line_id_record', sa.Integer(), autoincrement=False, nullable=True),
    sa.Column('ops_event_id', sa.Integer(), autoincrement=False, nullable=True),
    sa.Column('ops_event_id_record', sa.Integer(), autoincrement=False, nullable=True),
    ...
    sa.Column('history_type', postgresql.ENUM('AGREEMENT_CREATED', 'AGREEMENT_UPDATED', 'AGREEMENT_DELETED', 'BUDGET_LINE_ITEM_CREATED', 'BUDGET_LINE_ITEM_UPDATED', 'BUDGET_LINE_ITEM_DELETED', 'CHANGE_REQUEST_CREATED', 'CHANGE_REQUEST_UPDATED', 'CHANGE_REQUEST_DELETED', 'PROCUREMENT_SHOP_UPDATED', 'SERVICE_COMPONENT_CREATED', 'SERVICE_COMPONENT_UPDATED', 'SERVICE_COMPONENT_DELETED', name='agreementhistorytype', create_type=False), autoincrement=False, nullable=True),
    ...
    sa.Column('agreement_id_record', sa.Integer(), nullable=True),
    sa.Column('budget_line_id', sa.Integer(), nullable=True),
    sa.Column('budget_line_id_record', sa.Integer(), nullable=True),
    sa.Column('ops_event_id', sa.Integer(), nullable=True),
    sa.Column('ops_event_id_record', sa.Integer(), nullable=True),
    sa.Column('history_title', sa.String(), nullable=False),
    sa.Column('history_message', sa.Text(), nullable=False),
    sa.Column('timestamp', sa.String(), nullable=False),
    sa.Column('history_type', postgresql.ENUM('AGREEMENT_CREATED', 'AGREEMENT_UPDATED', 'AGREEMENT_DELETED', 'BUDGET_LINE_ITEM_CREATED', 'BUDGET_LINE_ITEM_UPDATED', 'BUDGET_LINE_ITEM_DELETED', 'CHANGE_REQUEST_CREATED', 'CHANGE_REQUEST_UPDATED', 'CHANGE_REQUEST_DELETED', 'PROCUREMENT_SHOP_UPDATED', 'SERVICE_COMPONENT_CREATED', 'SERVICE_COMPONENT_UPDATED', 'SERVICE_COMPONENT_DELETED', name='agreementhistorytype', create_type=False), nullable=True),
    sa.Column('created_by', sa.Integer(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.Column('created_on', sa.DateTime(), nullable=True),
    sa.Column('updated_on', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['agreement_id'], ['agreement.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['budget_line_id'], ['budget_line_item.id'], ondelete='SET NULL'),
...
def downgrade() -> None:
    ...
    op.sync_enum_values(
        enum_schema='ops',
        enum_name='opseventtype',
        new_values=['CREATE_BLI', 'UPDATE_BLI', 'DELETE_BLI', 'SEND_BLI_FOR_APPROVAL', 'CREATE_PROJECT', 'GET_AGREEMENT', 'CREATE_NEW_AGREEMENT', 'UPDATE_AGREEMENT', 'DELETE_AGREEMENT', 'CREATE_NEW_CAN', 'UPDATE_CAN', 'DELETE_CAN', 'CREATE_CAN_FUNDING_RECEIVED', 'UPDATE_CAN_FUNDING_RECEIVED', 'DELETE_CAN_FUNDING_RECEIVED', 'CREATE_CAN_FUNDING_BUDGET', 'UPDATE_CAN_FUNDING_BUDGET', 'DELETE_CAN_FUNDING_BUDGET', 'CREATE_CAN_FUNDING_DETAILS', 'UPDATE_CAN_FUNDING_DETAILS', 'DELETE_CAN_FUNDING_DETAILS', 'ACKNOWLEDGE_NOTIFICATION', 'CREATE_BLI_PACKAGE', 'UPDATE_BLI_PACKAGE', 'CREATE_SERVICES_COMPONENT', 'UPDATE_SERVICES_COMPONENT', 'DELETE_SERVICES_COMPONENT', 'CREATE_PROCUREMENT_ACQUISITION_PLANNING', 'UPDATE_PROCUREMENT_ACQUISITION_PLANNING', 'DELETE_PROCUREMENT_ACQUISITION_PLANNING', 'CREATE_DOCUMENT', 'UPDATE_DOCUMENT', 'LOGIN_ATTEMPT', 'LOGOUT', 'IDLE_LOGOUT', 'GET_USER_DETAILS', 'CREATE_USER', 'UPDATE_USER', 'DEACTIVATE_USER', 'CREATE_PORTFOLIO_URL', 'UPDATE_PORTFOLIO_URL', 'DELETE_PORTFOLIO_URL', 'CREATE_CHANGE_REQUEST', 'UPDATE_CHANGE_REQUEST', 'DELETE_CHANGE_REQUEST', 'CREATE_ROLE', 'UPDATE_ROLE', 'DELETE_ROLE'],
        affected_columns=[TableReference(table_schema='ops', table_name='ops_event', column_name='event_type'), TableReference(table_schema='ops', table_name='ops_event_version', column_name='event_type')],
        enum_values_to_rename=[],
    )
    ...
    sa.Enum('AGREEMENT_CREATED', 'AGREEMENT_UPDATED', 'AGREEMENT_DELETED', 'BUDGET_LINE_ITEM_CREATED', 'BUDGET_LINE_ITEM_UPDATED', 'BUDGET_LINE_ITEM_DELETED', 'CHANGE_REQUEST_CREATED', 'CHANGE_REQUEST_UPDATED', 'CHANGE_REQUEST_DELETED', 'PROCUREMENT_SHOP_UPDATED', 'SERVICE_COMPONENT_CREATED', 'SERVICE_COMPONENT_UPDATED', 'SERVICE_COMPONENT_DELETED', name='agreementhistorytype').drop(op.get_bind())
    # ### end Alembic commands ###
