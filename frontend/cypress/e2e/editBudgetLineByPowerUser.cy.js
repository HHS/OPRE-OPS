...
describe("Power User tests", () => {
    ...
    it("can edit a Direct Obligation agreement budget lines amount", () => {
        ...
        // create test agreement
        const grantAgreement = { ...testAgreement, agreement_type: AGREEMENT_TYPES.DIRECT_OBLIGATION };
        const bearer_token = `Bearer ${window.localStorage.getItem("access_token")}`;
        cy.request({
            method: "POST",
            url: "http://localhost:8080/api/v1/agreements/",
    ...
    it("can edit a CONTRACT agreement budget lines CAN", () => {
        expect(localStorage.getItem("access_token")).to.exist;
                ...
                cy.request({
                    ...
                    .then(({ agreementId, bliId }) => {
                        ...
                        cy.get('[data-cy="alert"]')
                            ...
                            .then(() => {
                                // verify the updated CAN is displayed in the table
                                cy.visit(`http://localhost:3000/agreements/${agreementId}/budget-lines`);
    ...
    it("can edit an AA agreement budget lines CAN", () => {
        expect(localStorage.getItem("access_token")).to.exist;
    ...
    it("can edit a GRANT agreement budget lines CAN", () => {
        expect(localStorage.getItem("access_token")).to.exist;
    ...
    it("can edit a Direct Obligation agreement budget lines CAN", () => {
        expect(localStorage.getItem("access_token")).to.exist;
    ...
    it("can edit an IAA agreement budget lines CAN", () => {
        expect(localStorage.getItem("access_token")).to.exist;
