...
describe("CAN List Filtering", () => {
    ...
    it("the filter button works as expected", () => {
        ...
        cy.get("button[id='filter-tag-activePeriod']").should("exist");
        cy.get("button[id='filter-tag-transfer']").should("exist");
        cy.get("button[id='filter-tag-portfolio']").should("exist");
        cy.get("button[id='filter-tag-can']").should("exist");
        cy.get("button[id='filter-tag-budget']").should("exist");
        ...
        cy.get("button[id='filter-tag-activePeriod']").should("not.exist");
        cy.get("button[id='filter-tag-transfer']").should("not.exist");
        cy.get("button[id='filter-tag-portfolio']").should("not.exist");
        cy.get("button[id='filter-tag-budget']").should("not.exist");
