...
// TODO: remove .only so all tests run
describe.only("agreement review CANS accordion", () => {
    // should not have any CANS cards unless BLIs are selected
    it.only("should not have any CANS cards unless BLIs are selected", () => {
        cy.visit("/agreements/approve/1");
        // pre-change
    ...
    // should have CANS cards if BLIs are selected
    // handle after approval toggle
    // handle over budget CAN cards- agreement 2
});
