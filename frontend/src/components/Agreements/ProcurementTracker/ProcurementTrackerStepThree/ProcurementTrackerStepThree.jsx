                ...
                (stepStatus === PROCUREMENT_STEP_STATUS.PENDING || stepStatus === PROCUREMENT_STEP_STATUS.ACTIVE) && (
                    <fieldset className="usa-fieldset">
                        <p>
                            ...
                            Solicitation Start and End Dates. After all proposals are received, vendor questions have
                            been answered, and evaluations are starting, check this step as complete.
                        </p>
                        ...
                        <div className="display-table">
                            ...
                            <div className="display-flex flex-justify-end">
                                <button
                                    ...
                                    onClick={() => handleSaveNotes(stepThreeData?.id)}
                                    disabled={isDisabled}
                                >
                                    <FontAwesomeIcon
                                        icon={faCheck}
                            ...
                            {isEditingNotes ? (
                                <div className="display-table">
                                    <TextArea
                                        ...
                                        value={step3Notes}
                                        onChange={
                                            /** @param {any} _ @param {any} value */ (_, value) => setStep3Notes(value)
                                        }
                                        textAreaStyle={{ height: "8.5rem", minWidth: "30rem" }}
                                        isDisabled={isDisabled}
                                    />
                                    <div className="display-flex flex-justify-end">
                                        ...
                                        <button
                                            ...
                                            data-cy="save-notes-button"
                                            onClick={async () => {
                                                await handleSaveNotes(stepThreeData?.id);
                                                setIsEditingNotes(false);
                                            }}
                                            disabled={isDisabled}
                                        >
