...
/**
 * GrantNumberSelect is a functional component that renders a Select component
 * for picking a placeholder Grant Number.
 *
 * @component
 ...
 */
function GrantNumberSelect({ value, onChange, options, isRequired, ...rest }) {
    return (
        <Select
            name="grantNumberSelect"
            label="Grant Number"
            onChange={onChange}
            value={value}
            messages={[]}
...
export default GrantNumberSelect;
