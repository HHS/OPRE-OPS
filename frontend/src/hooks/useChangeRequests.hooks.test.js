...
describe("useChangeRequestTotal", () => {
    ...
    it("returns total count with active user id", () => {
        ...
        useGetChangeRequestsListQueryMock.mockReturnValue({ data: { data: [{ id: 1 }, { id: 2 }], count: 2, limit: 10, offset: 0 } });
    ...
    it("falls back to zero when no list data and missing user", () => {
        ...
        expect(useGetChangeRequestsListQueryMock).toHaveBeenCalledWith({ userId: null, limit: 10, offset: 0 }, { skip: true });
