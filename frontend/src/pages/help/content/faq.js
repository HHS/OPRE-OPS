...
export const data = [
    {
        heading: "What is OPS?",
        content: `OPS is the acronym for **O**PRE's **P**ortfolio Management **S**ystem. It is a centralized place to plan and track OPRE's budget and projects across Divisions and Portfolios.
...
- Agreement - an agreement is a defined piece of work (possibly a subset of a broader project), often between OPRE and other contractors or partners
...
|-----------|---------|
| Draft              | Budget line is in pre-planning, placeholders, and what-ifs, and it's not subtracted from the FY budget |
| Planned            | Budget line is intended to happen, and money can be set aside as planned (even though there might be changes). The dollar amount associated with the budget line will be subtracted from the available FY budget |
...
- View all portfolios, projects, agreements, budget lines, and CANs
- Create agreements
- Create projects
- Edit agreements if you're listed as a team member on the agreement
- Edit projects if you're listed as a team member on any agreement within a project
- Request a status change on budget lines if you're listed as a team member on the agreement
- Complete the procurement tracker tasks for their agreements
...
- Create agreements
- Create projects
- Edit all projects and agreements
- Edit CAN details, FY budget, and update funding received to OPRE
- Review and approve all agreements for the pre-award step of the procurement tracker
  - Review the final consensus memo
  - Submit the requisition and write a check for the total in executing status
- Review and approve all agreements for the award step of the procurement tracker
...
- Edit agreements if you're listed as a team member on the agreement
- Edit projects if you're listed as a team member on any agreement within a project
- View the status of procurement tasks across all agreements
...
`
    },
    {
        ...
        content: `You can learn how to use OPS by checking out the [How-to Guides](/help-center), or reaching out for help by submitting a Budget Support Request through <a href="https://opre-orbit.zendesk.com" target="_blank" rel="noopener noreferrer">ORBIT</a>. For more detailed step-by-step instructions on ORBIT, check-out the how-to-guide on how to share OPS feedback or get support through <a href="https://opre-orbit.zendesk.com" target="_blank" rel="noopener noreferrer">ORBIT</a>.
`
    },
    {
...
- Create a new agreement (contracts, assisted acquisitions, and grants only)
...
- View or edit Projects
- Built-in approvals from Division Directors, when needed
...
`
    },
    {
        ...
        content: `
OPS will continue to get new features and improvements on a regular basis. If you have ideas, please share your feedback by submitting a Budget Support Request through <a href="https://opre-orbit.zendesk.com" target="_blank" rel="noopener noreferrer">ORBIT</a>.

A few items on our list so far include:

- View a Division including workforce/people management
- Create, view, or edit other agreement types like IAAs, and Direct Obligations
...
`
    },
    {
        ...
        content: `You can edit/update your agreements that are contracts, assisted acquisitions or grants directly in OPS. However, other agreement types are not fully developed yet and cannot be edited in OPS yet. The pages that are not editable will have an alert at the top so you know which pages aren't fully developed yet. Thank you for your patience on this!
`
    },
    {
...
`
    },
    {
        ...
        content: `If the agreement has not been awarded, you can delete any budget lines that are no longer needed. If the agreement has been awarded, please do not delete any budget lines in Planned or Executing Status that are not moving forward because it would impact the agreement total, which we want to match the award. These budget lines should instead be marked as OBE or "overcome by events". In order to do this, please reach out to the Budget Team by submitting a Budget Support Request through <a href="https://opre-orbit.zendesk.com" target="_blank" rel="noopener noreferrer">ORBIT</a>. They can mark the budget line as OBE or "overcome by events". Eventually, this will be available manually inside OPS.
`
    },
    {
...
`
    ...
    },
    {
        ...
        content: `OPS does not currently support downloading detailed reports. However, you can export raw data from any of the list pages (portfolios, projects, agreements, budget lines), as well as from an individual agreement. If you have ideas for reporting in OPS, please share your feedback by submitting a Budget Support Request through <a href="https://opre-orbit.zendesk.com" target="_blank" rel="noopener noreferrer">ORBIT</a>.
        `
    },
    {
...
Some teams might assign CORs to request the budget line status changes, but anyone who's listed as a Team Member on the agreement will be able to do it. The most important thing is that each team creates a process and makes sure OPS stays up to date in order to provide a holistic view of OPRE's budget at all times.
...
- In December, after plans are reviewed with OPRE leadership, CORs would go into OPS to change the BL Status from Draft to Planned. After that, the amounts would be subtracted from the FY Budget.
- In February and in June, when acquisition plans are typically due, CORs would go into OPS to change the BL Status from Planned to Executing. This would take place whenever you are ready to start the procurement process.
