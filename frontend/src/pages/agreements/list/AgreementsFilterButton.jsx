                    ...
                    <fieldset className="usa-fieldset margin-bottom-205">
                        ...
                        <div className="display-flex">
                            <div className={`usa-radio padding-right-5 ${customStyles.modalBackgroundColor}`}>
                                <div className="display-flex flex-align-center padding-top-1 padding-bottom-1">
                                    <input
                        ...
                        <fieldset className="usa-fieldset margin-bottom-205">
                            ...
                            <div className="display-flex">
                                <div className="padding-right-9">
                                    <div
                                        className={`usa-checkbox display-flex flex-align-center padding-top-1 padding-bottom-1 ${customStyles.modalBackgroundColor}`}
                                    >
                                        <input
