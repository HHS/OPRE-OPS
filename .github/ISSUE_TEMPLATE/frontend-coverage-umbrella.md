---
name: Frontend coverage umbrella
about: Track phased progress to 90% frontend unit test coverage.
title: "Frontend unit-test coverage to 90% (phased ratchet)"
labels: ""
assignees: ""
---
...
## Tracking
- [ ] Link child issue for Wave 1
- [ ] Link child issue for Wave 2
- [ ] Link child issue for Wave 3
- [ ] Link child issue for Wave 4
- [ ] Add weekly status update with coverage deltas and blockers
